#TOXIC CYBER SECURITY
#TANIM TERA REAL PAPPA

#SALA SCRIPT CHOR
#TAKA DIYE SCRIPT KINEK CHOR
...
def MainMenu():
    try:
        ...
        try:
            ...
            sys.exit("\n File Not Found!")        
        output = file.lower().replace('.py', '') + '_TOXIC-ENC.py'
        if option == 16:
            SEncode(data,output)
        else:
...
#TOXIC CYBER SECURITY
#FUCK MUSLIM CYBER SECURITY
#TOXIC IS ALWAYS FIRE
#MUNNA ER MAIRE CHUDI 365 DIN
#ALAMIN NASTIK KICK KHAUYA CEO
#BADOL KICK KHAUY CREW
